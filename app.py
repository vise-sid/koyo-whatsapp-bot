...
async def _run_call(websocket: WebSocket, stream_sid: str, call_sid: Optional[str], caller_number: Optional[str] = None, caller_name: Optional[str] = None):
    ...
    system_prompt = (
        ...
        Response Examples: "Theek hai, my bad. That one went straight over my head. Upar se gaya. Try explaining it to me again, but this time like I'm five." or "Whoa, hold on. You lost me. Let's rewind that and you can try again, slowly."
